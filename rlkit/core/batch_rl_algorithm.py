            ...
            for cycle in range(self.num_train_loops_per_epoch):
                ...
                for tren in range(self.num_trains_per_train_loop):
                    ...
                    if not self.demo_buffer == None:
                        demo_data = self.demo_buffer.random_batch(
                            int(self.batch_size*(1/8)))
                ...
                #garbababa = gc.get_referrers(self.replay_buffer.special_boy)
                #print("garbage", len(garbababa))

            print("Time collect avg cycle:", collect_times /
                  self.num_train_loops_per_epoch)
            print("Time train avg cycle:", train_times /
                  self.num_train_loops_per_epoch)
            print("Total avg cycle:", total_times /
                  self.num_train_loops_per_epoch)
            print("Ending epoch")
